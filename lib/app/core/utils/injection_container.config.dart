...
import 'package:spotify_ui_clone/features/album_view/cubit/album_view_cubit.dart'
    as _i9;
import 'package:spotify_ui_clone/features/auth/cubit/auth_cubit.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.AlbumViewRemoteRetrofitDataSource>(
        () => _i6.AlbumViewRemoteRetrofitDataSource(gh<_i3.Dio>()));
    gh.factory<_i7.AuthCubit>(() => _i7.AuthCubit(gh<_i5.LoginRepository>()));
    gh.factory<_i8.ItemsRepository>(() => _i8.ItemsRepository(
          albumViewRemoteDataSource:
              gh<_i6.AlbumViewRemoteRetrofitDataSource>(),
