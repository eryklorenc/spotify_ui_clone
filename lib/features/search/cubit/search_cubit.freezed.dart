...
mixin _$SearchState {
  ...
  List<String> get allGenres => throw _privateConstructorUsedError;
...
class _$SearchStateImpl implements _SearchState {
  const _$SearchStateImpl(
      ...
      this.errorMessage,
      required final List<String> allGenres,
  ...
  @override
  String toString() {
    return 'SearchState(status: $status, errorMessage: $errorMessage, allGenres: $allGenres, searchResults: $searchResults)';
  }
...
abstract class _SearchState implements SearchState {
  const factory _SearchState(
      ...
      final String? errorMessage,
      required final List<String> allGenres,
      required final List<String> searchResults}) = _$SearchStateImpl;
